...
//    {
//    case TAP_X_UP:
//        LOG_PORT.println("Tap X+ ");
//        break;
//    case TAP_X_DOWN:
//        LOG_PORT.println("Tap X- ");
//        break;
//    case TAP_Y_UP:
//        LOG_PORT.println("Tap Y+ ");
//        break;
//    case TAP_Y_DOWN:
//        LOG_PORT.println("Tap Y- ");
//        break;
//    case TAP_Z_UP:
//        LOG_PORT.println("Tap Z+ ");
//        break;
//    case TAP_Z_DOWN:
//        LOG_PORT.println("Tap Z- ");
//        break;
//    }
    ...
    LOG_PORT.print("#TAP=");
    LOG_PORT.println(tapCnt);
      
//    LOG_PORT.println(tapCnt);
//    unsigned int tapthresh = 1;
//    if (tapCnt > tapthresh) 
//    {
//      LOG_PORT.print("#TAP=");
//      LOG_PORT.println(tapCnt);
...
//    imuLog += String(imu.time) + ", "; // Add time to log string
      LOG_PORT.print(imu.time); LOG_PORT.print(",");
  }
...
//      imuLog += String(imu.calcAccel(imu.az)) + ", ";
      LOG_PORT.print(imu.calcAccel(imu.ax)); LOG_PORT.print(",");
      LOG_PORT.print(imu.calcAccel(imu.ay)); LOG_PORT.print(",");
      LOG_PORT.print(imu.calcAccel(imu.az)); LOG_PORT.print(",");
    }
    else
    {
//      imuLog += String(imu.ax) + ", ";
//      imuLog += String(imu.ay) + ", ";T
//      imuLog += String(imu.az) + ", ";
      LOG_PORT.print(imu.ax); LOG_PORT.print(",");
      LOG_PORT.print(imu.ay); LOG_PORT.print(",");
      LOG_PORT.print(imu.az); LOG_PORT.print(",");
    }
  }
...
//      imuLog += String(imu.calcQuat(imu.qz), 4) + ", ";
      LOG_PORT.print(String(imu.calcQuat(imu.qw), 6)); LOG_PORT.print(",");
      LOG_PORT.print(String(imu.calcQuat(imu.qx), 6)); LOG_PORT.print(",");
      LOG_PORT.print(String(imu.calcQuat(imu.qy), 6)); LOG_PORT.print(",");
      LOG_PORT.print(String(imu.calcQuat(imu.qz), 6)); LOG_PORT.println();
    }
    else
    {
...
//      LOG_PORT.print("#Q2=");
      LOG_PORT.print(imu.qw); LOG_PORT.print(",");
      LOG_PORT.print(imu.qx); LOG_PORT.print(",");
      LOG_PORT.print(imu.qy); LOG_PORT.print(",");
      LOG_PORT.print(imu.qz); LOG_PORT.println();
    }
  }
...
bool initIMU(void)
{
  ...
  // Configure sensors:
  imu.setSensors(INV_XYZ_GYRO | INV_XYZ_ACCEL); // no magnetometer: INV_XYZ_COMPASS
...
/*
  * KNOWN ISSUE: if you do not enable DMP_FEATURE_TAP
  * then the interrupts will be at 200Hz even if fifo rate
  * is set at a different rate. To avoid this issue include the DMP_FEATURE_TAP  */
